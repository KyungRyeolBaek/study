...
| --- | --- | --- | --- | --- | --- |
| 2 초 | 512 MB | 15454 | 5580 | 4404 | 36.746% |
...
- 문제를 각색한 사람: [AIAI](https://www.acmicpc.net/user/AIAI)
- 데이터를 추가한 사람: [bumsoo0515](https://www.acmicpc.net/user/bumsoo0515), [tkddn5623](https://www.acmicpc.net/user/tkddn5623), [xhdtlsid2](https://www.acmicpc.net/user/xhdtlsid2)
...
# compile을 사용하면 패턴을 앞에 주고 사용 할 수 있다.
pattern = re.compile
pattern.fullmatch(string)
```

[Python3 re로 문자열 처리. search, match, split](https://www.notion.so/Python3-re-search-match-split-dd58be07cb2d44fe8213bb6cba8bd51c?pvs=21)
'''
